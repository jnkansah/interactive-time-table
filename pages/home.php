      ...
      <div class="content-wrapper">
		...
		?>
							  <tr >
								...
								<td><input type="radio" id="check" name="m[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"></td>
								<td><input type="radio" id="check" name="w[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"></td>
								<td><input type="radio" id="check" name="f[]" value="<?php echo $id;?>" style="width: 20px; height: 20px;"></td>
                ...
                <div class="box-body">
				  ...
				  <div class="row">
					 <div class="col-md-12">
						  ...
						  <div class="form-group">
							<label for="date">Year Group</label>
